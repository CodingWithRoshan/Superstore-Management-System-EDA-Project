...
#Initalize faker for generating fake data
fake = Faker()
...
for i in range(1000): #1000 fake orders
    ...
    customer_segment_value = random.choice(customer_segment)
    ...
    delivery_status_value = random.choice(delivery_status)
    ...
    records.append({
        ...
        "Customer Segment": customer_segment_value,
        ...
        "Discount (%)": discount,
        "Sale Amount": round(sale_amount, 2),
        "Cost Price": round(cost_price, 2),
        "Profit": round(profit, 2),
        "Payment Mode": payment_mode,
        "Delivery Status": delivery_status_value,
...
try:
    ...
    print("Dataset generated and saved successfully! File saved as 'Superstore_Management_System.csv'")
except PermissionError:
    print("Please close the file 'Superstore_Management_System.csv' before running this script")
